classdef Test_NewClassStrategyResult 
	%% TEST_NEWCLASSSTRATEGYRESULT is the output result of NewClassStrategy
	%  Usage:  >> results = run(mlsystem.Test_NewClassStrategyResult)
	%          >> result  = run(mlsystem.Test_NewClassStrategyResult)
