classdef (Sealed) MatlabRegistry < mlsystem.MatlabSingleton
    ...
    properties (Constant)
        MLPACKAGES = {  ...
            ...
            'mlcapintec'  'mlct'        'mlchoosers'  'mlderdeyn'  'mldata'       'mldb'        'mldistcomp' 'mlentropy'  ...
            ...
            'mlsiemens'   'mlstan'      'mlstep2cs'   'mlsurfer'   'mlswisstrace' 'mlsystem' ...
            'mltvd'       'mlunpacking' 'mlusmle'     'mlblazey' ...
            }
        MLV_SERIAL = '7_9'
        MIN_VERSION = '7.11.0'
    end
    ...
    methods
        ...
        function setSrcPath(this)
            ...
            path([...
                ...
                fullfile(this.srcroot, 'gramm') pathsep ...
                ...
                fullfile(this.srcroot, 'xml_io_tools') pathsep ...
                fullfile(this.srcroot, 'coder_qFDG') pathsep ...
                fullfile(this.srcroot, 'coder_qFDG2')...
                ], path);
