classdef (Sealed) MatlabRegistry < mlsystem.MatlabSingleton
    ...
    properties (Constant)
        MLPACKAGES = { ...
            ...
            'mlcapintec'  'mlchoosers'  'mlderdeyn'   'mldata'     'mldb'         'mldistcomp'  'mlfdopa'    'mlentropy' ...
            'mlfourd'     'mlfourdfp'   'mlfsl'       'mlglucose' ...
            'mlio'        'mlkety'      'mlkinetics'  'mlmr'       'mlniftitools' 'mlnest'      'mlnipet'    'mloxygen' ...
        ...
        MORE_PACKAGES = { ...
            ...
            'javaplex/matlab_examples' 'lutbar' 'm2html' 'mfiles' 'StructBrowser' 'xml_io_tools' ...
