classdef NewClassStrategyResult 
	%% NEWCLASSSTRATEGYRESULT is the output result of NewClassStrategy
	%
	%  $Revision$ 
	%  was created $Date$ 
	%  by $Author$, 
	...
	methods 
		% N.B. (Abstract, Access='protected', Hidden, Sealed, Static) 
 		...
 		function this = NewClassStrategyResult(varargin) 
			%% NEWCLASSSTRATEGYRESULT 
			%  N/A 
